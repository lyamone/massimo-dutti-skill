...
const GOODBYE = 'Chau! Gracias por utilizar Massimo Dutti';
const UNHANDLED = 'This skill doesn\'t support that. Please ask something else.';
const NOTIFY_MISSING_PERMISSIONS = 'Por favor habilite los permisos de localizacion en la app de Amazon Alexa';
const CLOSER_STORE = 'La tienda mas cercana a tu localizacion es ';
